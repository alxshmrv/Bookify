...
internal sealed class GetLoggedInUserQueryHandler : IQueryHandler<GetLoggedInUserQuery, UserResponseDto>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var user = await connection.QuerySingleAsync<UserResponseDto>(
            sql,
            new
            {
